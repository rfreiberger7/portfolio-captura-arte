...
export async function storefrontApiRequest(query: string, variables: any = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Pagamento necessário", {
      description: "O acesso à API do Shopify requer um plano de cobrança ativo. Sua loja precisa ser atualizada para um plano pago. Visite https://admin.shopify.com para atualizar.",
    });
    return;
  }
